...
function cargarTabla(){
    ...
    if(isset($_SESSION['dbId'])){
        ...
        $botonAltaAdminHTML= '<a href="'.BASE_URL.'alta-pokemon.php" class="w-100 p-3 mt-3 mb-3 btn btn-outline-primary">Nuevo Pokemon</a>';
    }
    ...
    foreach ($pokemonsCargados as $pokemon){
        ...
        if(isset($_SESSION['dbId'])){
            ...
            $botonesBajaYModificacionAdminHTML = '<th>
                                                <div class="d-flex flex-column flex-md-row justify-content-evenly  pt-1">
                                                    <a href="'.BASE_URL.'modificar-pokemon.php?id='.$pokemon["id"].'" class="btn btn-outline-primary p-1 p-md-2">Modificacion</a>
                                                    <a href="'.BASE_URL.'scripts/procesar-baja.php?id='.$pokemon["id"].'" class="btn btn-outline-primary p-1 p-md-2 mt-2 mt-md-0" '.$atributoOnClick.'>Baja</a>
                                                </div>
                                               </th>';
        }
        ...
        $pokemonsHTML .= '<tr>
                        <th class="text-center align-middle">
                           <img class = "img-pokemon" src="'.BASE_URL.$pokemon["imagen"].'">
                        </th>
                        <th class="text-center align-middle">
                           <img src="'.BASE_URL.'imagenes/tipo/'.strtolower($pokemon["tipo"]).'.png">
                        </th>
                        <th class="text-center align-middle">
                           '.$pokemon["identificador_numerico"].'
                        </th>
                        <th class="text-center align-middle">
                           <a href="'.BASE_URL.'detalle.php?id='.$pokemon["id"].'">'.$pokemon["nombre"].'</a>
                        </th>
                       '.$botonesBajaYModificacionAdminHTML.'
                       </tr>';
    }
